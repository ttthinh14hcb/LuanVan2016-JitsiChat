...
/**
 * This adapter displays all <tt>MetaContactGroup</tt> items. If in the
 * constructor <tt>AdapterView</tt> id will be passed it will include
...
public class MetaContactGroupAdapter extends CollectionAdapter<Object> {
	...
	/**
	 * Creates new instance of <tt>MetaContactGroupAdapter</tt>. It will be
	 * filled with all currently available <tt>MetaContactGroup</tt>.
	 * 
	 * @param parent
	...
	public MetaContactGroupAdapter(Activity parent, int adapterViewId,
		...
		super(parent, getAllContactGroups(includeRoot, includeCreate)
				.iterator());
	...
	private void init(int adapterViewId) {
		AdapterView aView = (AdapterView) getParentActivity().findViewById(
				adapterViewId);
	 ...
	 * 
	 * @param includeRoot
	 *            indicates whether "No group" item should be included in the
	 *            list.
	 * @param includeCreateNew
	 *            indicates whether "create new group" item should be included
	 *            in the list.
	...
	private static List<Object> getAllContactGroups(boolean includeRoot,
		...
		MetaContactListService contactListService = AndroidGUIActivator
	 ...
	 */
	@Override
	protected View getView(boolean isDropDown, Object item, ViewGroup parent,
		...
		} else if (item.equals(AndroidGUIActivator.getContactListService()
				.getRoot())) {
			// Root
	 ...
	 * 
	 * @param newGroup
	 *            new contact group if was created or <tt>null</tt> if user

    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        if(item.getItemId() == R.id.switch_camera)
        {
        	...
        	case R.id.rota_left_playback:
        		if(count > 0){
        			float rot = remoteVideoContainer.getChildAt(count - 1).getRotation();
        			remoteVideoContainer.getChildAt(count - 1).setRotation(rot - 90f);
        			float X = remoteVideoContainer.getChildAt(count - 1).getX();
        			remoteVideoContainer.getChildAt(count - 1).setX(remoteVideoContainer.getChildAt(count - 1).getY());
        			remoteVideoContainer.getChildAt(count - 1).setY(X);
        		}
        		//remoteVideoContainer.setRotation(remoteVideoContainer.getRotation() - 90f);
        		break;
        	case R.id.rota_right_playback:
        		if(count > 0){
        			float rot = remoteVideoContainer.getChildAt(count - 1).getRotation();
        			remoteVideoContainer.getChildAt(count - 1).setRotation(rot + 90f);
        			float X = remoteVideoContainer.getChildAt(count - 1).getX();

...
public class NotificationSettings extends OSGiActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.notificationService = ServiceUtils.getService(
				AndroidGUIActivator.bundleContext, NotificationService.class);
	 ...
	 */
	class NotificationsAdapter extends BaseAdapter implements
		...
		NotificationsAdapter() {
			Iterator<String> eventsIter = notificationService
					.getRegisteredEvents().iterator();
		...
		public View getView(final int position, View convertView,
			...
			row.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					Intent details = NotificationDetails.getIntent(
			...
			CompoundButton enableBtn = (CompoundButton) row
					.findViewById(R.id.enable);

			enableBtn.setChecked(notificationService.isActive(events
					.get(position)));

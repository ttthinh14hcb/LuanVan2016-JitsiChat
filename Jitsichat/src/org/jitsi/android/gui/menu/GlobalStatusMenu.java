    ...
    implements OnDismissListener
{
    ...
    private List<ActionMenuItem> actionItems = new ArrayList<ActionMenuItem>();
    ...
    public GlobalStatusMenu(Context context)
    {
        mContext = context;
     ...
     */
    public ActionMenuItem getActionItem(int index)
    {
    ...
    {
        public abstract void onItemClick(   GlobalStatusMenu source,
                                            int pos,
                                            int actionId);
    }
        ...
        container.setOnClickListener(new OnClickListener()
        {
            public void onClick(View v)
            {
                if (mItemClickListener != null)
                    mItemClickListener
                        .onItemClick(GlobalStatusMenu.this, pos, actionId);
    ...
    private void showArrow(int whichArrow, int requestedX)
    {
        final View showArrow
            = (whichArrow == R.id.arrow_up) ? mArrowUp : mArrowDown;
        final View hideArrow
            = (whichArrow == R.id.arrow_up) ? mArrowDown : mArrowUp;

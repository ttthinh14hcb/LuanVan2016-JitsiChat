    ...
    extends DialogFragment
{
     ...
     */
    @SuppressLint("UseValueOf") public void commit(SecurityAccountRegistration securityReg)
    {
        ...
        implements TouchInterceptor.DropListener
    {
        ...
        @SuppressLint("ViewHolder") public View getView(int i, View view, ViewGroup viewGroup)
        {
